    ...
    return (
      ...
      <Navbar />
        ...
        <div class="row justify-content-center">
            <div class="col-md-4">
                <div class="card mb-3">
                    <img src="/img/8.png" class="card-img-top custom-img img-thumbnail"
                        alt="Card Image"></img>
                    <div class="card-body text-center">
                        <h5 class="card-title">จัดออกงาน</h5>
            ...
            <div class="col-md-4">
                <div class="card mb-3">
                    <img src="/img/6.png" class="custom-img"
                        alt="Card Image"></img>
                    <div class="card-body text-center">
                        <h5 class="card-title">จ้างเชพส่วนตัวไปทำอาหาร</h5>
            ...
            <div class="col-md-4">
                <div class="card mb-3">
                    <img src="/img/8.png" class="card-img-top custom-img"
                        alt="Card Image"></img>
                    <div class="card-body text-center">
                        <h5 class="card-title">ขายเพรนชาย</h5>
